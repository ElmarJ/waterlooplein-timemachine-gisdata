...
Project to reconstruct the development of the Waterlooplein neighborhood between 1800 and 2000 in GeoJson. Data is used by the [Waterlooplein 3D project](https://github.com/ElmarJ/Waterlooplein3D). See [https://waterlooplein3d.nl] for more information about the whole project.
